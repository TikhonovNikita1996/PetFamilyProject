...
namespace PetFamily.Accounts.Infrastructure.Migrations
{
    ...
    [Migration("20250119150616_Volunteer Account update")]
    partial class VolunteerAccountupdate
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            modelBuilder
                .HasDefaultSchema("PetFamily_Accounts")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<System.Guid>", b =>
                {
                    ...
                    b.ToTable("role_claims", "PetFamily_Accounts");
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    ...
                    b.ToTable("user_claims", "PetFamily_Accounts");
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserLogin<System.Guid>", b =>
                {
                    ...
                    b.ToTable("user_logins", "PetFamily_Accounts");
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserRole<System.Guid>", b =>
                {
                    ...
                    b.ToTable("user_roles", "PetFamily_Accounts");
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserToken<System.Guid>", b =>
                {
                    ...
                    b.ToTable("user_tokens", "PetFamily_Accounts");
                });

            modelBuilder.Entity("PetFamily.Accounts.Domain.AccountModels.AdminAccount", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("admin_accounts", "PetFamily_Accounts");
                });

            modelBuilder.Entity("PetFamily.Accounts.Domain.AccountModels.ParticipantAccount", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("participant_accounts", "PetFamily_Accounts");
                });

            modelBuilder.Entity("PetFamily.Accounts.Domain.AccountModels.VolunteerAccount", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("WorkingExperience", "PetFamily.Accounts.Domain.AccountModels.VolunteerAccount.WorkingExperience#WorkingExperience", b1 =>
                        {
                            b1.IsRequired();
                    ...
                    b.ToTable("volunteer_accounts", "PetFamily_Accounts");
                });
            ...
            modelBuilder.Entity("PetFamily.Accounts.Domain.Permission", b =>
                {
                    ...
                    b.ToTable("permissions", "PetFamily_Accounts");
                });
            ...
            modelBuilder.Entity("PetFamily.Accounts.Domain.RefreshSession", b =>
                {
                    ...
                    b.ToTable("refresh_sessions", "PetFamily_Accounts");
                });
            ...
            modelBuilder.Entity("PetFamily.Accounts.Domain.Role", b =>
                {
                    ...
                    b.ToTable("roles", "PetFamily_Accounts");
                });
            ...
            modelBuilder.Entity("PetFamily.Accounts.Domain.RolePermission", b =>
                {
                    ...
                    b.ToTable("role_permissions", "PetFamily_Accounts");
                });
            ...
            modelBuilder.Entity("PetFamily.Accounts.Domain.User", b =>
                {
                    ...
                    b.ToTable("users", "PetFamily_Accounts");
                });
            ...
            modelBuilder.Entity("PetFamily.Accounts.Domain.AccountModels.AdminAccount", b =>
                {
                    b.HasOne("PetFamily.Accounts.Domain.User", "User")
                        ...
                        .HasForeignKey("PetFamily.Accounts.Domain.AccountModels.AdminAccount", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("PetFamily.Accounts.Domain.AccountModels.ParticipantAccount", b =>
                {
                    b.HasOne("PetFamily.Accounts.Domain.User", "User")
                        ...
                        .HasForeignKey("PetFamily.Accounts.Domain.AccountModels.ParticipantAccount", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("PetFamily.Accounts.Domain.AccountModels.VolunteerAccount", b =>
                {
                    b.HasOne("PetFamily.Accounts.Domain.User", "User")
                        ...
                        .HasForeignKey("PetFamily.Accounts.Domain.AccountModels.VolunteerAccount", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
